        ...
        <div style="direction: rtl">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview @if($sidebarName == 'products' or $sidebarName == 'categories' or $sidebarName == 'attributes' or $sidebarName == 'discounts'or $sidebarName == 'orders' ) menu-open @endif">
                        <a href="#" class="nav-link @if($sidebarName == 'products' or $sidebarName == 'categories' or $sidebarName == 'attributes' or $sidebarName == 'discounts'or $sidebarName == 'orders') active @endif">
