            ...
            <div class="row border-bottom cart-item-wrapper">
                ...
                <div class="col-4 col-md-2 secondary d-flex align-items-start justify-content-center flex-column flex-md-row quantity-col">
                    ...
                    <div class="d-flex quantity-input px-0">
                        <button class="border-left-0 p-0 p-lg-2 cart-product-quantity-plus" type="button"
                        data-point="1" data-url="{{ url("api/cart/". $cartId ."/cartItem/". $cartItem['cartItemId'] . "/change-quantity") }}"
                        @if(!$cartItem['has_enough_entity']) disabled @endif>
                        ...
                        <button class="border-right-0 p-0 p-lg-2 cart-product-quantity-minus" type="button"
                        data-point="-1"
                        data-url="{{ url("api/cart/". $cartId ."/cartItem/". $cartItem['cartItemId'] . "/change-quantity") }}">
        ...
        $(document).ready(function () {
            $(".address-option input").change(function () {
                if ($(this).is(':checked')) {
                    ...
                    $('.total-price').text(
                        number_format(
                            shipment_price + {{$totalPriceWithDiscount}},
                            0,
                            0,
                            ','
                        ) +
