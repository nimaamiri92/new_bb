            ...
            <div class="col-md-5 col-12 position-relative">
                ...
                <div id="accordion" class="product-more-info">
                    <div class="border-top">
                        ...
                        <div id="desCollapse" class="collapse" data-parent="#accordion">
                    ...
                    <div id="related-list" class="owl-carousel">
                        @foreach($similarProducts as $similarProduct)
                            ...
                            <div class="d-flex justify-content-between pl-2">
                                ...
                                <p class="old-price">{{ $similarProduct->price }} ريال</p>
                            </div>
                            <span class="recommendations__item__off-badge">{{ $similarProduct->product_discount }}% تخفیف</span>
                        </div>
                        @endforeach
                    </div>
                </div>
